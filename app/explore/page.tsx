...
const categories = ["All", "Photography", "Music", "Fitness", "Cooking", "Art", "Technology", "Business"]
...
const contentData = [
  ...
  },
  {
    ...
    likes: 567,
    duration: "2h 30m",
    description: "Master the basics of beat making with step-by-step tutorials and real-world examples.",
  },
  {
    id: 3,
...
export default function ExplorePage() {
  ...
  const handlePurchaseContent = async (contentId: number) => {
    console.log(`Simulated API call: POST /api/content/${contentId}/purchase`)
    // Backend will handle payment processing
  }
              ...
              <div className="relative">
                ...
                >
                  <Button
                    ...
                    onClick={() => (content.price > 0 ? handlePurchaseContent(content.id) : null)}
                  >
              ...
              <CardHeader className="pb-3">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-muted-foreground">{content.creator.name}</span>
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-sm text-muted-foreground">({content.reviews})</span>
                  </div>
                </div>

                <CardTitle className="text-lg line-clamp-2 mb-2">{content.title}</CardTitle>
                <CardDescription className="line-clamp-2 mb-3">{content.description}</CardDescription>
                  ...
                  <div className="flex items-center space-x-2">
                    {content.price > 0 ? (
                      <div className="flex items-center space-x-2">
                        ...
                        {content.originalPrice && (
                          <span className="text-sm text-muted-foreground line-through">${content.originalPrice}</span>
                        )}
                      </div>
                    ) : (
