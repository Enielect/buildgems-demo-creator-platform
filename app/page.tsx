...
const featuredCreators = [
  {
    id: 1,
    name: "Sarah Chen",
    avatar: "/professional-woman-creator.png",
  ...
  },
  {
    ...
    avatar: "/female-fitness-instructor.png",
    category: "Fitness",
    subscribers: 15200,
        ...
        <div className="container mx-auto text-center">
          <div className="animate-fade-in-up">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto text-pretty">
              Build your audience, sell your content, and earn recurring revenue. The all-in-one platform for creators
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featuredCreators.map((creator, index) => (
              <Card
                key={creator.id}
                className="hover:shadow-lg transition-all duration-300 animate-fade-in-up cursor-pointer"
                ...
                <CardContent>
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <div className="text-right">
                      <p className="font-semibold text-green-600">${creator.monthlyEarnings.toLocaleString()}</p>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featuredContent.map((content, index) => (
              <Card
                key={content.id}
                className="overflow-hidden hover:shadow-lg transition-all duration-300 animate-fade-in-up group cursor-pointer"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    {content.price > 0 ? (
                      <span className="font-bold text-primary">${content.price}</span>
                    ) : (
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Join thousands of creators who are already building their audience and earning from their content.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" asChild>
                <Link href="/member/signup">Join as Member</Link>
              </Button>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li>
                  <Link href="/creator/dashboard" className="hover:text-foreground transition-colors">
                    Dashboard
                  </Link>
                </li>
                <li>
                  <Link href="/creator/analytics" className="hover:text-foreground transition-colors">
                    Analytics
                  </Link>
                </li>
                <li>
                  <Link href="/creator/payouts" className="hover:text-foreground transition-colors">
                    Payouts
                  </Link>
                </li>
              </ul>
